...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_def')) {
        Object.defineProperty(Module['ready'], '_def', { configurable: true, get: function() { abort('You are getting _def on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_def', { configurable: true, set: function() { abort('You are setting _def on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _zlibCli = Module["_zlibCli"] = createExportWrapper("zlibCli");

/** @type {function(...*):?} */
var _readFileByLines = Module["_readFileByLines"] = createExportWrapper("readFileByLines");
